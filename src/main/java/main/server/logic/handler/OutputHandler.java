...
public class OutputHandler {
	...
	public Output clerkLogin(String input) {
		...
		if (input.equalsIgnoreCase(Config.CLERK_PASSWORD1)) {
			output.setOutput("What can I do for you? Menu: Create Course/Student, Delete Course/Student, Cancel Course, Dean's List.");
			output.setState(CLERK);
		} else if (input.equalsIgnoreCase(Config.CLERK_PASSWORD2)) {
			output.setOutput("What can I do for you? Menu: Create Course/Student, Delete Course/Student, Cancel Course, Dean's List.");
			output.setState(CLERK);
		}  else if (input.equalsIgnoreCase(Config.CLERK_PASSWORD3)) {
			output.setOutput("What can I do for you? Menu: Create Course/Student, Delete Course/Student, Cancel Course, Dean's List.");
			output.setState(CLERK);
		} else {
