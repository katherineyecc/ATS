...
public class StepDefUC9 extends TestCase {
	...
	@When("^The Student logs into the system and enters \"([^\"]*)\"$")
	public void the_Student_logs_into_the_system_and_enters(String arg1) throws Throwable {
		...
		if(state == 0) {
			if(output.contentEquals("Successfully Log Out!\n")) {
				success = true;
			}
		}
		ats = null;
	...
	@Then("^The Student logs out the system successfully$")
	public void the_Student_logs_out_the_system_successfully() throws Throwable {
