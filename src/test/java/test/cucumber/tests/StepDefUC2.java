...
public class StepDefUC2 extends TestCase {
	...
	@When("^The Clerk logs into ATS and enters \"([^\"]*)\" not to log out$")
	public void the_Clerk_logs_into_ATS_and_enters_not_to_log_out(String arg1) {
		ats = new ATServer(Config.DEFAULT_PORT);
		Thread t = new Thread(ats);
		t.start();
		try {
	...
	public void the_Clerk_does_t_log_out() {
	    assertEquals(true, success);
	}
