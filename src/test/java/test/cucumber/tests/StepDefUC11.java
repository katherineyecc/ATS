...
public class StepDefUC11 extends TestCase {
	...
	@When("^The Student logs in ATS and inputs \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\"$")
	public void the_Student_logs_in_ATS_and_inputs_and_and_and_and_and(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6) throws Throwable {
		ats = new ATServer(Config.DEFAULT_PORT);
		Thread t = new Thread(ats);
		t.start();
		try {
	...
	public void the_Student_deregisters_for_a_course_successfully() throws Throwable {
		assertEquals(true, success);
	}
}
