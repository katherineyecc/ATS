...
public class StepDefUC4 extends TestCase {
	...
	@When("^The Clerk logs into ATS and enters \"([^\"]*)\" and enters \"([^\"]*)\" and current term does not end and registration does not starts$")
	public void the_Clerk_logs_into_ATS_and_enters_and_enters_and_current_term_does_not_end_and_registration_does_not_starts(String arg1, String arg2) throws AWTException {
		ats = new ATServer(Config.DEFAULT_PORT);
		Thread t = new Thread(ats);
		t.start();
		try {
	...
	@When("^The Clerk logs into ATS and enters \"([^\"]*)\" and enters \"([^\"]*)\" and current term does not end and registration does not start$")
	public void the_Clerk_logs_into_ATS_and_enters_and_enters_and_current_term_does_not_end_and_registration_does_not_start(String arg1, String arg2) throws AWTException {
		ats = new ATServer(Config.DEFAULT_PORT);
		Thread t = new Thread(ats);
		t.start();
		try {
